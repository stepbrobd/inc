...
in
{
  ...
  services.as10779 = {
    ...
    local = {
      ...
      interface = {
        local = lib.blueprint.hosts.roraima.ipam.interface;
        primary = lib.blueprint.hosts.roraima.interface;
      };
      ipv4.addresses = [
        "${lib.blueprint.hosts.roraima.ipam.ipv4}/32" # unicast
        "23.161.104.17/32" # personal site anycast
      ];
      ipv6.addresses = [
        "${lib.blueprint.hosts.roraima.ipam.ipv6}/128" # unicast
    ...
    router = {
      ...
      source = { inherit (lib.blueprint.hosts.roraima) ipv4 ipv6; };
      static =
        let
          option = "reject";
        in
